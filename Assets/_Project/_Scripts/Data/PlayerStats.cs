...
public class PlayerStats : ScriptableObject
{
    ...
    [Header("Temel De�erler (Ba�lang��)")]
    public float baseMaxHealth = 100f;
    public float baseMoveSpeed = 5f;
    public float baseDamage = 10f;
    public float baseFireRate = 0.5f;

    [Header("Anl�k De�erler (Oyun ��i)")]
    ...
    // Oyun ba�lad���nda veya �ld���m�zde de�erleri s�f�rlamak i�in
    ...
    /// <summary>
    /// Statları harici bir yerden güncellemek için (GameProgressManager için)
    /// </summary>
